 ...
 * @author DThanh
 */
public class MyListModelSelected extends AbstractListModel {

    public MyListModelSelected(String connect, int ageCode) throws SQLException {
        super();
    ...
    public void getListContent(int ageCode) throws SQLException {
        content = dao.showActivitySelected(ageCode);
    }
