 ...
 * @author  Tuong Huy
 */
public class dialog_SelectNannyForChild extends javax.swing.JDialog {
    ...
    MainForm main = null;
    frm_ChildList frmParent = null;
    public static dialog_Add_InformationOfChild dialogAdd = null;
    int selectedRow = -1;

    /** Creates new form dialog_SelectNanny */
    public dialog_SelectNannyForChild(java.awt.Frame parent, boolean modal, String _sConn, String _sSQL, Child _child, dialog_Add_InformationOfChild _dialogAdd) {
        super(parent, modal);
        initComponents();
        ...
        dialogAdd = (dialog_Add_InformationOfChild) _dialogAdd;
        sConn = _sConn;
        child = (Child) _child;
        daochild = new DAO_Child(sConn);

        String sSQLNanny = "SELECT ROW_NUMBER() OVER (ORDER BY Name Asc) AS No, n.NannyCode, n.Name, n.ChildAssignedToHer, COALESCE(a.NumOfChild, 0) As NumOfChild ";
        sSQLNanny += "FROM tbl_Nanny n ";
        sSQLNanny += "LEFT OUTER JOIN (SELECT Count(NannyCode)As NumOfChild, NannyCode FROM tbl_Child_Nanny GROUP BY NannyCode) a ";
        sSQLNanny += "ON a.NannyCode = n.NannyCode Order By Name Asc";
        LoadDataIntoJTable(sSQLNanny, sConn);
    }
...
// TODO add your handling code here:
        if (selectedRow != -1) {
            ...
            if (maxChild == curChild) {
                ...
                int iResult = JOptionPane.showConfirmDialog(this, "Do you want to select this nanny for child?", "Confirm", JOptionPane.YES_NO_OPTION);
                if (iResult == JOptionPane.YES_OPTION) {
                    child.setNannyCode(tblNannyList.getModel().getValueAt(selectedRow, 1).toString());
                    try {
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new dialog_SelectNannyForChild(new javax.swing.JFrame(), true, sConn, sSQL, child, dialogAdd).setVisible(true);
            }
        });
    }
